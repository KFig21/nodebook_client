const outrunTheme = {
  colors: {
    ...
    editTextAreaBackgroundColor: "#090c26",
    // post-editing
    ...
    // notification
    notificationContainerColor: "transparent",
    ...
    notificationSeenButtonFadedBorder: "rgba(0, 147, 255, .5)",
    notificationDeleteButtonFaded: "transparent",
    notificationDeleteButtonFadedText: "rgba(254, 49, 171, .5)",
    notificationDeleteButtonFadedBorder: "rgba(254, 49, 171, .5)",
    notificationSeenButton: "rgba(0, 147, 255, 1)",
    notificationSeenButtonText: "#000000",
    notificationDeleteButton: "rgba(254, 49, 171, 1)",
    notificationDeleteButtonText: "#000000",
    // text
    primaryColorContrastText: "rgb(247, 247, 247)",
    textWhite: "rgb(247, 247, 247)",
    notificationCountColor: "#090c26",
